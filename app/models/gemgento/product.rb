module Gemgento
  class Product < ActiveRecord::Base
    ...
    has_and_belongs_to_many :categories, join_table: 'gemgento_categories_products', conditions: { :uniq => true }
    has_many :assets
    ...
    has_and_belongs_to_many :configurable_attributes, join_table: 'gemgento_configurable_attributes', class_name: 'ProductAttribute', conditions: { :uniq => true }
